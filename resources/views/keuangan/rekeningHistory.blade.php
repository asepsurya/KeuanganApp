...
@section('container')
    <div class="px-2 py-1 mb-4 flex items-center justify-between">
        ...
        <a href="{{ route('history.cetak-pdf',$id_rekening) }}" target="_blank" class="inline-block bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition flex items-center gap-2">
    ...
    <div class="border bg-lightwhite dark:bg-white/5 dark:border-white/10 border-black/10 p-5 rounded-md">
        <div class="mb-4">
            <p class="text-sm font-semibold text-black/40">Riwayat Transaksi</p>
        </div>
