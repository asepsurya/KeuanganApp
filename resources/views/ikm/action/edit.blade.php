...
@section('container')
    <form action="{{ route('ikm.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="px-2 py-1 mb-4 flex items-center justify-between">
            ...
            <button class="px-4 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition ">+ Update
                Data</button>
        </div>
            ...
            <div class="grid grid-cols-1 2xl:grid-cols-2 gap-2">
                <div>
                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        ...
                        <input type="text" name="nik" placeholder="NIK" class="form-input"
                    ...
                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        ...
                        <input type="text" name="id_provinsi" placeholder="ID Provinsi" class="form-input"
                            value="{{ old('id_provinsi', $item->id_provinsi ?? '') }}" />
                    </div>

                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Kota (ID)</label>
                        <input type="text" name="id_kota" placeholder="ID Kota" class="form-input"
                            value="{{ old('id_kota', $item->id_kota ?? '') }}" />
                    </div>

                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Kecamatan (ID)</label>
                        <input type="text" name="id_kecamatan" placeholder="ID Kecamatan" class="form-input"
                            value="{{ old('id_kecamatan', $item->id_kecamatan ?? '') }}" />
                    </div>

                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Desa (ID)</label>
                        <input type="text" name="id_desa" placeholder="ID Desa" class="form-input"
                            value="{{ old('id_desa', $item->id_desa ?? '') }}" />
                    </div>

                    <!-- Lainnya -->
                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        <label class="block mb-1 text-xs text-black/40 dark:text-white/40">Agama</label>
                        <input type="text" name="agama" placeholder="Agama" class="form-input"
                    ...
                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        ...
                        <input type="text" name="status_perkawinan" placeholder="Status Perkawinan"
                            class="form-input" value="{{ old('status_perkawinan', $item->status_perkawinan ?? '') }}" />
                    </div>
                ...
                <div>
                    ...
                    <div class="py-4 px-5 mb-3 bg-white rounded-lg border border-black/10 relative dark:bg-white/5">
                        ...
                        <input type="text" name="kewarganegaraan" placeholder="Kewarganegaraan" class="form-input"
