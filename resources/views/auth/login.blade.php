...
<body>
    <main class="bg-white w-full rounded-lg flex flex-col md:flex-row overflow-hidden min-h-screen">
        ...
        <section class="w-full md:w-1/2 p-8 md:p-16">
            ...
            <div class="flex items-center my-8 text-[#64748b] text-sm">
                <hr class="flex-grow border-t border-[#cbd5e1]" />
                <span class="mx-4 whitespace-nowrap">
                    Or sign up with
                </span>
                <hr class="flex-grow border-t border-[#cbd5e1]" />
            </div>
            <div class="grid grid-cols-1 gap-6">
                <button
                    class="flex items-center justify-center space-x-2 border border-[#e2e8f0] rounded-lg py-3 font-semibold text-[#334155] hover:bg-[#f8fafc] transition">
                    <img alt="Google G logo" class="w-5 h-5"
