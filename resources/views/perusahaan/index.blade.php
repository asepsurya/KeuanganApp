            ...
            <form action="{{ route('perusahaan.update.legalitas') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="legalitas-container">
                    ...
                    <div class="border border-black/10 dark:border-white/10 rounded-lg mb-2">
                        ...
                        <div id="accordion-{{ $key }}" class="px-4 py-3 bg-white dark:bg-white/5 rounded-b-lg">
                            <div
                                class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 mb-4">
                                <label class="block text-xs text-black/40 dark:text-white/40 mb-1">{{ $label }}</label>
                                ...
                                <input type="hidden" name="legalitas_existing[{{ $key }}][type]" value="{{ $key }}">
                            </div>
                    ...
                    <div class="border border-black/10 dark:border-white/10 rounded-lg mb-2">
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button type="button" class="font-semibold text-sm bg-transparent focus:outline-none"
                        ...
                        <div id="accordion-lain-{{ $idx }}" class="hidden  px-4 py-3 bg-white dark:bg-white/5 rounded-b-lg">
                            <div
                                class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 mb-4">
                                <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Nama
                                    Legalitas</label>
                                <input type="text" name="legalitas_existing_other[{{ $idx }}][type]"
                                    value="{{ $item->legalitas }}"
                                    class="form-input w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200/50 transition"
                                    required />

                                <label class="block text-xs text-black/40 dark:text-white/40 mb-1 mt-3">Nomor</label>
                                <input type="text" name="legalitas_existing_other[{{ $idx }}][nomor]"
                                    value="{{ $item->nomor }}"
                                    class="form-input w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200/50 transition"
                                    required />
                            ...
                            <div
                                ...
                                <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Upload
                                    Dokumen</label>
                                <input type="file" name="legalitas_existing_other[{{ $idx }}][lampiran]"
                                    class="form-input w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200/50 transition" />
                            </div>
                        </div>
                    </div>
...
<nav
    ...
    <div class="flex justify-between items-center px-6 h-16">
        ...
        <button onclick="openTab('tab-stamp')"
            class="flex flex-col items-center justify-center text-sm text-gray-700 dark:text-white hover:text-blue-600 dark:hover:text-blue-400">
            <svg class="w-5 h-5 mb-1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none"
...
function resetFileInput(input) {
    ...
    const preview = document.getElementById('logo-preview');
    preview.src = '{{ $perusahaan->logo ? asset("storage/".$perusahaan->logo) : asset("assets/images/inopak.jpg") }}';
}
</script>
