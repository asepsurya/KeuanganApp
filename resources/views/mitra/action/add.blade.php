        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="border border-black/10 dark:border-white/10 p-5 rounded-md">
                    ...
                    <input type="text" id="gmaps-link" placeholder="Paste link Google Maps di sini" class="form-input w-full">
                    </div>
        ...
        <div >
            <div class="border bg-lightwhite dark:bg-white/5 dark:border-white/10 border-black/10 p-5 rounded-md">
                <div class="px-2 py-1 mb-4 flex items-center justify-between">
                    ...
                    <button type="button"
                        class="px-2 py-1 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition"
                        onclick="addRow()">
                        + Tambah Produk
                    </button>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            Rp.
                            <input type="text" name="harga[]" value="{{ number_format($row->harga, 0, ',', '.') }}"
                                oninput="formatCurrency(this)" class="form-input harga-input">
                        </td>
                        <td><button type="button" class="text-red-600 hover:text-red-800" onclick="removeRow(this)" data-id="{{ $row->id }}">Hapus</button></td>
                    </tr>
                @empty
                    <tr id="noDataRow">
