            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2">
                    <div class="h-6 w-6 flex-none rounded-full overflow-hidden">
                        <img src="{{ asset('assets/images/avatar-1.png') }}" class="object-cover" alt="avatar" />
                    </div>
                    <div class="flex-1">
                        <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[200px] text-black dark:text-white">
                            Edited the details of Project X</p>
                        <p class="text-xs text-black/40 dark:text-white/40">5m ago</p>
                    </div>
                </div>
        ...
        <div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2 items-center">
                    <img src="{{ asset('assets/images/avatar-6.png') }}" class="h-6 w-6 flex-none rounded-full object-cover"
                        alt="avatar" />
